...
export default function PedirRecambios() {
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <main className="container mx-auto py-12">
        <section className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-4">Pedir Recambios</h2>
          <p className="text-lg mb-6">Solicita recambios originales para mantener tus estufas en perfecto estado.</p>
        </section>
      </main>
